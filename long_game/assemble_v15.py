#!/usr/bin/env python3
"""Assemble the v15 cut into outputs/previews/preview_v15.mp4.
...
GRADE = {}  # b7 grade now baked into b7_name3_bronze.mp4 (Hald LUT histogram match)
...
graph_file = ROOT / "outputs/assemble_v15_graph.txt"
...
subprocess.run(["ffmpeg", "-y", "-v", "error"] + inputs
               + ["-filter_complex_script", str(graph_file),
                  ...
                  str(ROOT / "outputs/previews/preview_v15.mp4")], check=True)
print("wrote outputs/previews/preview_v15.mp4")
