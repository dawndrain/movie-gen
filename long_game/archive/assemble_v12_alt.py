...
graph_file = ROOT / "outputs/assemble_v12alt_graph.txt"
...
subprocess.run(["ffmpeg", "-y", "-v", "error"] + inputs
               + ["-filter_complex_script", str(graph_file),
                  ...
                  str(ROOT / "outputs/previews/preview_v12_alt_ending.mp4")], check=True)
print("wrote outputs/previews/preview_v12_alt_ending.mp4")
