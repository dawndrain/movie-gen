#!/usr/bin/env python3
"""v17: THE cut (credits ending promoted per Dawn). Cuts mid-second exit attempt,
...
graph_file = ROOT / "outputs/assemble_v17_graph.txt"
...
subprocess.run(["ffmpeg", "-y", "-v", "error"] + inputs
               + ["-filter_complex_script", str(graph_file),
                  ...
                  str(ROOT / "outputs/previews/preview_v17.mp4")], check=True)
print("wrote outputs/previews/preview_v17.mp4")
