#!/usr/bin/env python3
"""v16: THE cut (credits ending promoted per Dawn). Cuts mid-second exit attempt,
...
CUT = [
    ...
    (V12 / "a_hard_fix.mp4", 0, 2.70, False, None),   # "Easy is boring. Hard mode."
    (V16 / "a_smoke_stand2.mp4", 0, 4.3, False, None),  # native cutaway, Deshawn STANDING, empty arcade
    (V12 / "a_hard_fix.mp4", 5.60, None, False, None),   # Milo cranks the dial
    # --- Bronze ---
    ...
    (V16 / "q2_longtime3.mp4", 0, None, False, None),  # native line, just the three of them
...
graph_file = ROOT / "outputs/assemble_v16_graph.txt"
...
subprocess.run(["ffmpeg", "-y", "-v", "error"] + inputs
               + ["-filter_complex_script", str(graph_file),
                  ...
                  str(ROOT / "outputs/previews/preview_v16.mp4")], check=True)
print("wrote outputs/previews/preview_v16.mp4")
