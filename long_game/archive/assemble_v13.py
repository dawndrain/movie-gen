#!/usr/bin/env python3
"""Assemble the v13 cut into outputs/previews/preview_v13.mp4.
...
graph_file = ROOT / "outputs/assemble_v13_graph.txt"
...
subprocess.run(["ffmpeg", "-y", "-v", "error"] + inputs
               + ["-filter_complex_script", str(graph_file),
                  ...
                  str(ROOT / "outputs/previews/preview_v13.mp4")], check=True)
print("wrote outputs/previews/preview_v13.mp4")
