...
CUT = [
    ...
    (V14 / "r9_acid5.mp4", 0, None, False, None),    # doodle-page insert, no lip-flap
...
GRADE = {"b7_name3": "eq=saturation=0.45,colorbalance=bs=0.12:bm=0.08:bh=0.06,",
         "q7_fail2": "fade=t=out:st=7.25:d=0.25,"}  # dip to black into credits
...
graph_file = ROOT / "outputs/assemble_v14alt_graph.txt"
...
subprocess.run(["ffmpeg", "-y", "-v", "error"] + inputs
               + ["-filter_complex_script", str(graph_file),
                  ...
                  str(ROOT / "outputs/previews/preview_v14_alt_ending.mp4")], check=True)
print("wrote outputs/previews/preview_v14_alt_ending.mp4")
