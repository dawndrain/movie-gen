#!/usr/bin/env python3
"""Assemble the v14 cut into outputs/previews/preview_v14.mp4.
...
GRADE = {"b7_name3": "eq=saturation=0.45,colorbalance=bs=0.12:bm=0.08:bh=0.06,"}  # cold bronze blue
...
graph_file = ROOT / "outputs/assemble_v14_graph.txt"
...
subprocess.run(["ffmpeg", "-y", "-v", "error"] + inputs
               + ["-filter_complex_script", str(graph_file),
                  ...
                  str(ROOT / "outputs/previews/preview_v14.mp4")], check=True)
print("wrote outputs/previews/preview_v14.mp4")
