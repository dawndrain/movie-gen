#!/usr/bin/env python3
"""Assemble the v12 cut into outputs/previews/preview_v12.mp4.
...
CUT = [
    ...
    (V12 / "w1_fix.mp4", 0, None, False, None),      # "...Again." dubbed         # respawn: "...Again."
    ...
    (V11 / "n9_sixty2.mp4", 0, None, False, "m1926"),  # no press phase-through
    # --- 1926 ---
...
graph_file = ROOT / "outputs/assemble_v12_graph.txt"
...
subprocess.run(["ffmpeg", "-y", "-v", "error"] + inputs
               + ["-filter_complex_script", str(graph_file),
                  ...
                  str(ROOT / "outputs/previews/preview_v12.mp4")], check=True)
print("wrote outputs/previews/preview_v12.mp4")
