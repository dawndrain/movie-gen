...
CUT = [
    ...
    (V14 / "a_smoke_insert.mp4", 0, 3.95, False, None),  # native cutaway: the smoke line
...
GRADE = {"q7_fail2": "fade=t=out:st=7.25:d=0.25,"}  # dip to black into credits; b7 baked into file
...
graph_file = ROOT / "outputs/assemble_v15alt_graph.txt"
...
subprocess.run(["ffmpeg", "-y", "-v", "error"] + inputs
               + ["-filter_complex_script", str(graph_file),
                  ...
                  str(ROOT / "outputs/previews/preview_v15_alt_ending.mp4")], check=True)
print("wrote outputs/previews/preview_v15_alt_ending.mp4")
