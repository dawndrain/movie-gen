#!/usr/bin/env python3
"""Assemble the v6 director's cut into outputs/preview_v6.mp4.
...
CUT = [
    ...
    (V6 / "a_ski.mp4", 0, None, False, None),
    (V5 / "a8_out2.mp4", 0, None, False, None),
    (V6 / "a_hard.mp4", 0, None, False, None),
    (V6 / "a10_v3.mp4", 0, None, False, None),
    # --- Bronze ---
    (V6 / "b1_wake3.mp4", 0, None, False, "bronze"),
    (V2 / "2_2_water_carry.mp4", 0, None, False, None),
    (V3 / "b3_goat.mp4", 0, None, False, None),
    (V3 / "b12_cough.mp4", 0, None, False, None),        # cough sets up death #1
    ...
    (V6 / "w1_again.mp4", 0, None, False, None),         # respawn: "...Again."
    (V6 / "b13_cry2.mp4", 0, None, False, None),
    (V3 / "b14_three_lives.mp4", 0, None, False, None),
    (V6 / "w2_dead.mp4", 0, None, False, None),          # respawn: playing dead
    ...
    (V2 / "3_1_salt_water.mp4", 0, None, False, None),
    (V5 / "b20_solemn2.mp4", 0, None, False, None),
    (V2 / "3_3_good_years.mp4", 0, None, False, None),
    (V5 / "b22_wish2.mp4", 0, None, False, None),
    (V5 / "b23_finally2.mp4", 0, None, False, None),
    # --- Roman ---
    (V6 / "r1_sigh.mp4", 0, None, False, "roman"),
    (V6 / "r2_aq2.mp4", 0, None, False, None),
    ...
    (V6 / "r12_salt3.mp4", 0, None, False, None),
    (V5 / "r13_sweet2.mp4", 0, None, False, None),
    # --- Renaissance ---
    (V4 / "n1_bridge.mp4", 0, None, False, "ren"),
    (V4 / "n2_widow.mp4", 0, None, False, None),
    (V4 / "n3_card.mp4", 0, None, False, None),
    (V3 / "e1_library2.mp4", 0, None, False, None),
    (V3 / "e2_fire.mp4", 0, 6.9, False, None),
    (V4 / "n4_fireflash.mp4", 0, None, False, None),
    (V3 / "e2_fire.mp4", 6.9, None, False, None),
    (V3 / "e3_flood.mp4", 0, None, False, None),         # vow BEFORE the type CU
    ...
    (V6 / "p4_exit2.mp4", 0, None, False, None),
    # --- The arcade, again ---
    ...
    (V6 / "q4_real2.mp4", 0, None, False, "end"),
    (V4 / "q5_nested.mp4", 0, None, False, None),
    (V4 / "q6_longtime2.mp4", 0, None, False, None),
    (V6 / "q7_fail2.mp4", 0, None, False, None),
    (V6 / "q8_come2.mp4", 0, None, False, None),
]

# era -> (music file, volume). "silence"/"boiler" handled via span logic below.
MUSIC = {
    "omen": ("mus_omen.m4a", 0.22),
    "arcade": ("mus_arcade2.m4a", 0.10),
    "bronze": ("mus_bronze.m4a", 0.09),
    "roman": ("mus_roman.m4a", 0.08),
    "ren": ("mus_ren.m4a", 0.10),
    "boiler": ("mus_boiler.m4a", 0.20),
    "m1926": ("mus_1926.m4a", 0.10),
    "machine": ("mus_machine.m4a", 0.11),
    "end": ("mus_end.m4a", 0.14),
}
...
graph_file = ROOT / "outputs/assemble_v6_graph.txt"
...
subprocess.run(["ffmpeg", "-y", "-v", "error"] + inputs
               + ["-filter_complex_script", str(graph_file),
                  ...
                  str(ROOT / "outputs/preview_v6.mp4")], check=True)
print("wrote outputs/preview_v6.mp4")
