#!/usr/bin/env python3
"""Assemble the v11 cut into outputs/previews/preview_v11.mp4.
...
CUT = [
    ...
    (V11 / "t0_dubbed.mp4", 0, None, False, "omen"),   # redubbed, not re-rendered
    ...
    (V11 / "b6_scream4.mp4", 0, None, False, None),  # same respawn frame + mom voice ref
    ...
    (V10 / "w1d.mp4", 0, None, False, None),         # respawn: "...Again."
    ...
    (V4 / "p3_manual.mp4", 0, None, False, "machine"),
...
MUSIC = {
    ...
    "m1926": ("mus_1926.m4a", 0.09),         # widow's nod -> 3s into the dinner
...
graph_file = ROOT / "outputs/assemble_v11_graph.txt"
...
subprocess.run(["ffmpeg", "-y", "-v", "error"] + inputs
               + ["-filter_complex_script", str(graph_file),
                  ...
                  str(ROOT / "outputs/previews/preview_v11.mp4")], check=True)
print("wrote outputs/previews/preview_v11.mp4")
