#!/usr/bin/env python3
"""Assemble the v10 cut into outputs/preview_v10.mp4.
...
CUT = [
    ...
    (V10 / "t0_onelife3.mp4", 0, None, False, "omen"),
    (V10 / "a6_sign4.mp4", 0, None, False, "arcade"),
    ...
    (V6 / "b6_scream2.mp4", 0, None, False, None),  # reverted to the working take
...
graph_file = ROOT / "outputs/assemble_v10_graph.txt"
...
subprocess.run(["ffmpeg", "-y", "-v", "error"] + inputs
               + ["-filter_complex_script", str(graph_file),
                  ...
                  str(ROOT / "outputs/preview_v10.mp4")], check=True)
print("wrote outputs/preview_v10.mp4")
