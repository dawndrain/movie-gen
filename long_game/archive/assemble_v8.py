#!/usr/bin/env python3
"""Assemble the v8 cut into outputs/preview_v8.mp4.
...
CUT = [
    ...
    (V8 / "b9_summers.mp4", 0, None, False, None),
...
graph_file = ROOT / "outputs/assemble_v8_graph.txt"
...
subprocess.run(["ffmpeg", "-y", "-v", "error"] + inputs
               + ["-filter_complex_script", str(graph_file),
                  ...
                  str(ROOT / "outputs/preview_v8.mp4")], check=True)
print("wrote outputs/preview_v8.mp4")
