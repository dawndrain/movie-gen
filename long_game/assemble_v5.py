#!/usr/bin/env python3
"""Assemble the v5 comedy cut (retake pass) into outputs/preview_v5.mp4. No narration — dialogue
...
V5 = ROOT / "outputs/video5"

# (clip path, trim_start, trim_dur, mute) — trim_dur None = to end
CUT = [
    # --- Cold open + Arcade ---
    (V5 / "t0_onelife.mp4", 0, None, False),             # ONE CREDIT / ONE LIFE
    (V5 / "a1_ddr2.mp4", 0, None, False),
    ...
    # --- 1926 ---
    (V5 / "m1_wake2.mp4", 0, None, False),
    (V5 / "m2_tram2.mp4", 0, None, False),
    (V5 / "m3_twenty2.mp4", 0, None, False),
...
graph_file = ROOT / "outputs/assemble_v5_graph.txt"
...
subprocess.run(["ffmpeg", "-y", "-v", "error"] + inputs
               + ["-filter_complex_script", str(graph_file),
                  ...
                  str(ROOT / "outputs/preview_v5.mp4")], check=True)
print("wrote outputs/preview_v5.mp4")
